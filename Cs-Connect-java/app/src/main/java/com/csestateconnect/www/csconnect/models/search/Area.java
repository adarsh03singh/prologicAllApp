...
public class Area implements Serializable
{
    ...
    @Expose
    private List<Bucket____> buckets = null;
    private final static long serialVersionUID = -2638986093904854889L;
     ...
     */
    public Area(Long docCountErrorUpperBound, Long sumOtherDocCount, List<Bucket____> buckets) {
        super();
    ...
    public List<Bucket____> getBuckets() {
        return buckets;
    }

    public void setBuckets(List<Bucket____> buckets) {
        this.buckets = buckets;
    }
