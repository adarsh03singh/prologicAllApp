...
public class ProjectImage implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<ProjectImage> CREATOR = new Creator<ProjectImage>() {


        @SuppressWarnings({
                "unchecked"
        })
        public ProjectImage createFromParcel(Parcel in) {
            return new ProjectImage(in);
        }
        ...
        public ProjectImage[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = -3923827395128676202L;
