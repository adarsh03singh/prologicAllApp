...
class UpdateReimbursementDocsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_update_reimbursement_docs, container, false)

        val binding: FragmentUpdateReimbursementBinding = FragmentUpdateReimbursementBinding.bind(view)
