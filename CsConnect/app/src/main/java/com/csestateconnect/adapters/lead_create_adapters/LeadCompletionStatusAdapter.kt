...
class LeadCompletionStatusAdapter(val cityName: MutableList<String>, val itemClick: (List<String>) -> Unit) : RecyclerView.Adapter<LeadCompletionStatusAdapter.ViewHolder>() {
